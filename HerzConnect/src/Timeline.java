 ...
 * Timeline.java
 *
 * Created on Oct 16, 2015, 9:39:04 PM
 */
...
public class Timeline extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel18.setText("<html><u>See Older Posts");
...
try{
   String q1="Select count(*) from post"+no+" where Seen=0;";
    ...
    jLabel15.setText("You have "+pnum+" new posts.");
    con2.close();
    s2.close();
    rs2.close();
    }
...
{
String output="<html>";
String q="Select Text,Image,Owner,Kind,Time from Post"+code+" where Serial>0 and Seen=0;";
Class.forName("java.sql.Driver");
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
Statement s=con.createStatement();
ResultSet r=s.executeQuery(q);
...
while(r.next()){
    ...
    if(kind.equals("text")){
        ...
        image="<img src='file:/D:/ChatApp/"+image+".jpg'>";
        text=text+"<br>";
        x=" shared a photo............";
    }
    ...
    output=output+"<font size=4 color=grey>"+owner+x+".................................</font><font size=2>("+t+")</font><br>"+color+text+image+"<br>"+"--------------------------------------------------------------------------------------------------------</font><br>";
}
...
new Settings().setVisible(true);        // TODO add your handling code here:
 ...
 int res=JOptionPane.showConfirmDialog(null,"Are You Sure to delete all Posts?");
        if(res==JOptionPane.YES_OPTION){
            try {
                String q="Delete from Post"+code+" where Serial>0;";
                Class.forName("java.sql.Driver");
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
                Statement s=con.createStatement();
                s.executeUpdate(q);
...
try {
 ...
 try {
     String q1="insert into Notif"+c+" values("+noti+",'"+n+" posted a Status Update.',0);";
...
int se=0;
try{
   String q1="Select Serial from Post"+code+";";
   String q2="Select Serial from Notif"+code+";";
    Class.forName("java.sql.Driver");
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
    Statement s1=con.createStatement();
...
try {
      String q="insert into Post"+code+" values("+se+",'"+text+"','"+image+"','"+user+"','"+kind+"',mid(now(),12),0);";
      String q1="insert into Notif"+code+" values("+not+",'You posted a Status Update.',0);";
      Class.forName("java.sql.Driver");
      Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
      Statement s=con.createStatement();
      s.executeUpdate(q);
...
{
String output="<html>";
String q="Select Text,Image,Owner,Kind,Time from Post"+code+" where Serial>0 and Seen=1;";
Class.forName("java.sql.Driver");
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
Statement s=con.createStatement();
ResultSet r=s.executeQuery(q);
