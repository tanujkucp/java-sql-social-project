 ...
 * Settings.java
 *
 * Created on Oct 16, 2015, 11:28:26 PM
 */
...
try{
   String q1="Select Email,Phno,Dpsmall from members where code="+code+";";
    Class.forName("java.sql.Driver");
...
try{
   String q1="update members set Name='"+name+"', Username='"+user+"', Email='"+email+"', Phno='"+phno+"' where Code="+code+";";
    Class.forName("java.sql.Driver");
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
    Statement s1=con.createStatement();
    s1.executeUpdate(q1);
   ...
   String qu="delete from current;";
    String q="insert into current values("+code+",'"+name+"','"+user+"','"+pass+"');";
    Class.forName("java.sql.Driver");
...
try {
      String q="select Reciever from srequest"+code+";";
      Class.forName("java.sql.Driver");
      Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
      Statement s=con.createStatement();
      ResultSet rs=s.executeQuery(q);
           while(rs.next()){
           String r=rs.getString("Reciever");
           int c=0;
           int noti=0;
    try{
    ...
    Connection con1=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
     ...
     rsa.next();
     c=rsa.getInt("Code");
    String q2="Select Serial from Notif"+c+";";
 ...
 try {
     ...
     String q1="insert into Notif"+c+" values("+noti+",'"+n+" Changed name to "+name+".',0);";
...
try {
      String q="select Sender from arequest"+code+";";
      Class.forName("java.sql.Driver");
      Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
      Statement s=con.createStatement();
      ResultSet rs=s.executeQuery(q);
           while(rs.next()){
           String r=rs.getString("Sender");
           int c=0;
           int noti=0;
    try{
    String a="Select Code from members where Name='"+r+"';";
...
try {
      String q="select Code from Friendlist"+code+";";
      Class.forName("java.sql.Driver");
      Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
      Statement s=con.createStatement();
      ResultSet rs=s.executeQuery(q);
...
try{
   String q1="update members set Password='"+npass1+"' where Code="+code+";";
    Class.forName("java.sql.Driver");
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
    Statement s1=con.createStatement();
    s1.executeUpdate(q1);
    ...
    try{
   String qu="delete from current;";
    String q="insert into current values("+code+",'"+name+"','"+user+"','"+npass1+"');";
    Class.forName("java.sql.Driver");
    Connection co=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
    Statement s=co.createStatement();
    Statement st=co.createStatement();
