 ...
 * SignUp.java
 *
 * Created on Oct 17, 2015, 12:16:04 AM
 */
...
{
try{
   String q1="insert into members(Code,Name,Username,Password,Seccode,Email,Phno,Gender,Birthday,Likes,Accountcreated) values("+code+",'"+name+"','"+user+"','"+pass1+"',"+seccode+",'"+email+"',"+phno+",'"+gender+"','"+birth+"',1,curdate());";
    Class.forName("java.sql.Driver");
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
    Statement s1=con.createStatement();
    s1.executeUpdate(q1);
