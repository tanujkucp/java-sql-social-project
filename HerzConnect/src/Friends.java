 ...
 * Friends.java
 *
 * Created on Oct 16, 2015, 10:08:28 PM
 */
...
try{
   String q2="Select count(*) from Arequest"+no+";";
    Class.forName("java.sql.Driver");
    ...
    String q1="Select Sender from Arequest"+no+";";
    ...
    while(rs1.next()){
             String f=rs1.getString("Sender");
           m.addElement(f);
                         }
        jList1.setModel(m);

        String q="Select Name from Friendlist"+no+";";
...
try{
   String q1="Select Serial from Friendlist"+code1+";";
...
try{
 ...
 String qa="Select Serial from Notif"+code1+";";
...
int not2=0;
   try{
    String q1="delete from arequest"+code1+" where Sender='"+a2+"';";
    ...
    String q3="Select Serial from Notif"+code1+";";
    ...
    String q5="insert into Notif"+code1+" values("+not1+",'You Deleted Friend Request From "+a2+"',0);";
    Statement s5=con1.createStatement();
    s5.executeUpdate(q5);

    String q6="insert into Notif"+code2+" values("+not2+",'"+a1+" Deleted Your Friend Request.',0);";
    Statement s6=con1.createStatement();
    s6.executeUpdate(q6);
     this.setVisible(false);
 new Friends().setVisible(true);
...
int no=Integer.parseInt(jLabel17.getText());
   ...
   Class.forName("java.sql.Driver");
    Connection con1=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
    Statement s1=con1.createStatement();
    String q1="Select Reciever from srequest"+no+";";
    ResultSet rs1=s1.executeQuery(q1);
    if(rs1.next()){
        rs1.previous();
        DefaultListModel m=(DefaultListModel)jList1.getModel();
        m.clear();
          while(rs1.next()){
             String f=rs1.getString("Reciever");
           m.addElement(f);
                         }
        jList1.setModel(m);
