 ...
 * NewMessage.java
 *
 * Created on Oct 17, 2015, 10:27:18 PM
 */
...
try{
   String q1="insert into Message"+code1+" values("+se1+",'"+text+"','"+name1+"','"+name2+"',mid(now(),12),0,'"+kind+"');";
...
try{
   String q1="insert into Message"+code1+" values("+se1+",'"+image+"','"+name1+"','"+name2+"',mid(now(),12),0,'"+kind+"');";
