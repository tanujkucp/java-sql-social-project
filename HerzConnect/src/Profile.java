 ...
 * Profile.java
 *
 * Created on Oct 16, 2015, 11:05:50 PM
 */
...
try{
   String q1="Select Email,Phno,Nickname,Job,Workingat,Hobbies,Likes,Dpbig,Dpsmall from members where code="+code+";";
    Class.forName("java.sql.Driver");
...
try {
      String q="Select Count(*) from Friendlist"+code+";";
      Class.forName("java.sql.Driver");
      Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
      Statement s=con.createStatement();
...
try {
      String q="Select Count(*) from Liked"+code+";";
      Class.forName("java.sql.Driver");
      Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
      Statement s=con.createStatement();
      ResultSet rs=s.executeQuery(q);
