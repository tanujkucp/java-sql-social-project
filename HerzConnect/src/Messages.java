 ...
 * Messages.java
 *
 * Created on Oct 16, 2015, 10:29:46 PM
 */
...
public class Messages extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/untitle.png"))); // NOI18N
        jButton3.setText("Write New Message");
        ...
        jList1.setFont(new java.awt.Font("Arial Unicode MS", 1, 36));
        ...
        jButton5.setText("<html>Delete All<br>Messages ");
        ...
        jLabel13.setText("<html>Start Chatting from Below<font color=blue> ↴↓");
...
try{
   ...
   rs2.next();
    mnum=rs2.getInt("Count(*)");

    jLabel15.setText("You have "+mnum+" new Messages.");
    con2.close();
    s2.close();
    rs2.close();
    }
...
try {
      String q="Select Name from Friendlist"+code+";";
      Class.forName("java.sql.Driver");
      Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
      Statement s=con.createStatement();
     ...
     if(rs.next()){
         ...
         m.addElement(f);
          ...
          m.addElement("You Have No Friends!");
...
int code=Integer.parseInt(jLabel11.getText());
 int res=JOptionPane.showConfirmDialog(null,"Are You Sure to delete all Messages?");
        if(res==JOptionPane.YES_OPTION){
            try {
                String q="Delete from Message"+code+" where Serial>0;";
                Class.forName("java.sql.Driver");
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
                Statement s=con.createStatement();
                s.executeUpdate(q);
                JOptionPane.showMessageDialog(null,"All Messages Deleted Successfully!");
                 this.setVisible(false);
