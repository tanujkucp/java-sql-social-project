 ...
 * LogIn.java
 *
 * Created on Oct 16, 2015, 11:54:24 PM
 */
...
try{
   String q1="Select Password from members where Username='tmehta';";
...
String name="";
try{
   String q1="Select Code,Name, Password from members where Username='"+user+"';";
    Class.forName("java.sql.Driver");
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
    Statement s1=con.createStatement();
    ResultSet rs=s1.executeQuery(q1);
   ...
   s.executeUpdate(q);
    ...
    JOptionPane.showMessageDialog(null,""+e.getMessage() );
            ...
            this.setVisible(false);
            JOptionPane.showMessageDialog(null,"<html><h1>*****Welcome*****</h1><br><h1><font color=blue> "+name );
