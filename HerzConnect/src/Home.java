 ...
 * Home.java
 *
 * Created on Oct 16, 2015, 8:03:20 PM
 */
...
try{
    String q1="select Name,Code from friendlist"+code+";";
    Class.forName("java.sql.Driver");
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
    Statement s1=con.createStatement();
    ResultSet rs=s1.executeQuery(q1);
    while(rs.next()){
    int cs=rs.getInt("Code");
    ...
    if(d.equals(da)){
         int noti=0;
         String q3="Select Serial from Notif"+code+";";
         Statement s3=con1.createStatement();
         ResultSet rs3=s3.executeQuery(q3);
      rs3.last();
      noti=rs3.getInt("Serial");
      noti++;
      String q4="insert into Notif"+code+" values("+noti+",'"+n+" has birthday today...,Wish Him!',0);";
...
int nnum=0;
try{
   String q1="Select count(*) from post"+no+" where Seen=0;";
    Class.forName("java.sql.Driver");
...
try{
   String q1="Select count(*) from Message"+no+" where Seen=0;";
    Class.forName("java.sql.Driver");
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tanuj","root","123");
    Statement s1=con.createStatement();
    ResultSet rs=s1.executeQuery(q1);
...
jLabel15.setText("You have "+pnum+" new posts, "+mnum+" new messages, and "+nnum+" new notifications!");
